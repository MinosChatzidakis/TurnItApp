...
import { FaThumbsDown as ThumbsDown, FaThumbsUp as ThumbsUp } from 'react-icons/fa';

const LeaderboardCard = ({ song= {}, onClick= () => console.log("no event handler given"), onLike=() => console.log("no event handler given"), onDislike= () => console.log("no event handler given"), liked= null, disliked= null, rank }) => {
  ...
  return (
    <div className="leaderboard-card" onClick={onClick}>
      ...
      <img src={song.thumbnail} alt={`${song.name} cover`} className="leaderboard-image" />
      ...
      <div className="leaderboard-actions">
        ...
        
        {
          liked!==null &&
          <ThumbsUp 
          color={liked ? "#1DB954" : "grey"} /* Changed to Spotify Green for fun! */
